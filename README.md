...
| Python (CPython) | AtCoder と同じバージョンに固定 ([python/cpython-freeze.txt](python/cpython-freeze.txt))。numpy、scipy、pandas、polars、scikit-learn、lightgbm、torch (CPU)、numba、ortools、PuLP、z3-solver、networkx、rustworkx、sympy、gmpy2、shapely、sortedcontainers、more-itertools、bitarray、ac-library-python、acl-cpp-python、cppyy など |
